...
<head>
    ...
    <meta http-equiv="refresh" content="600; url=https://www.asharalo.trodev.com/">

 <link rel="canonical" href="https://www.asharalo.trodev.com/">
    ...
    <script type="application/ld+json">
        {
          ...
          "@type": "Organization",
          "name": "Ashar Alo Shop",
          "url": "https://asharalo.trodev.com/",
          "logo": "https://asharalo.trodev.com/public/img/logo.PNG",
    ...
    <div class="container">
        ...
        <div class="row featured__filter">
            @foreach($product as $prod)
                <div class="col-lg-3 product-item {{$prod->sub_category}}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center">
                    <a href="{{route('shop-grid')}}" class="site-btn">View All</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            @foreach($lateset as $late)
                                <a href="{{route('shop-details',['product'=>$late->id])}}" class="latest-product__item">
                                    ...
                                    <div class="latest-product__item__text">
                                        ...
                                        @if(isset($late->discount))
                                            <p style="text-decoration: line-through;">Tk. {{$late->previous_price}}</p>
                                            <p>{{$late->discount}}%</p>
                                        @endif
                                ...
                                @if($mosted->total_sold > 15)
                                    <a href="{{route('shop-details',['product'=>$mosted->id])}}" class="latest-product__item">
                                        ...
                                        <div class="latest-product__item__text">
                                            ...
                                            @if(isset($mosted->discount))
                                                <p style="text-decoration: line-through;">Tk. {{$mosted->previous_price}}</p>
                                                <p>{{$mosted->discount}}%</p>
                                            @endif
                                        </div>
                                    </a>
